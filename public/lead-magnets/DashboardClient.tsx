              ...
              <div className="db-card" style={{ marginTop: '1rem' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(130px,1fr))', gap: '.65rem' }}>
                  {[
                    ...
                    return (
                      <div key={days} style={{ padding: '.85rem', borderRadius: var(--r16), background: reached ? 'rgba(0,196,106,.08)' : 'rgba(255,255,255,.02)', border: `1px solid ${reached ? 'var(--green-line)' : 'rgba(255,255,255,.06)'}`, textAlign: 'center' }}>
